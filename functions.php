...
function add_admin_link($items, $args) {
    ...
    if (is_user_logged_in() && $args->theme_location == 'mobile_menu') {
        ...
        $admin_link = '<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-36 current_page_item menu-item-45"><a href="'. get_admin_url() .'" class="menu-link">Admin</a></li>';
